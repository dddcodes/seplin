...
function generateQuizes(){
    ...
    if (catalog_quizesGenerated >= questList.length & catalog_allQuizesGenerated === false) {
        console.log("i es mayor a questlist.length")
        console.log(questList.length-m)

        catalogPage.innerHTML += '<div class="simpleBox">NO HAY MAS QUIZES</div><br>';
    } else if(catalog_quizesGenerated = false){
        catalogPage.innerHTML += '<div class="simpleBox">Presiona "MOSTRAR MAS" para ver mas</div>';
    }
