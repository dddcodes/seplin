...
function showCatalog(){
    ...
    for (let i = 0; i < questList.length; i++) {
        ...
        const isDefault = (element.default)?" SOY UN QUIZ DE PRUEBA :D ... ":"";
        ...
        <div class="simpleBox ${color}" id="quest${i}" style="text-align: left; ">
            ...
            <button class="miniBtn" id="catalogQuestRemoveViewBtn${i}"
                ...
                <ion-icon name="eye-off">${OV("", "Ocultar info")}</ion-icon>
            </button>
...
function view(ubication){
    ...
    const classes = "niceBox mainClr3";
...
const catalogToWelcomePageBtn = document.querySelector("#catalogToWelcomePageBtn");
const catalogToSetQuestPageBtn = document.querySelector("#catalogToSetQuestPageBtn")
