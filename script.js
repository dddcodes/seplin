...
function showCatalog(){
    ...
    for (let i = 0; i < questList.length; i++) {
        ...
        const isDefault = (element.default)?" DEFAULT QUIZ ... ":"";
        const color = (element.default)?"blue-3":"";
        catalogPage.innerHTML += `
        <br/>
        <div class="simpleBox ${color}" id="quest${i}" style="text-align: left; ">

            <p class="main-clr" style="margin: 10px;">${isDefault}</p>
...
filterSubmitBtn.addEventListener("click",() => { //subir filtros...
    ...
    appear(filterLabel);
    filterLabel.innerHTML = "<p class='simpleBox llamativeClr'>FILTROS EDITADOS EXITOSAMENTE!</p>"
